...
export class PredictionService {
  ...
  async handleCron() {
    ...
    ]; //deberia tener un solo jugador (el que tenga mas goles)
    ...
    for (const playerPrediction of playersPredictions) {
      if (playerPrediction.name === jugadores[0].playerName) {
      ...
      if (Number(playerPrediction.goals) === Number(jugadores[0].goalsCount)) {
    ...
    //peticion a jugadores de la champions league
